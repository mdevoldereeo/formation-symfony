...
use Europa\BlogBundle\Entity\Tag;
use Europa\BlogBundle\Form\TagType;
...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EuropaBlogBundle:Tag')->findAll();
     ...
     * @Method("POST")
     * @Template("EuropaBlogBundle:Tag:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EuropaBlogBundle:Tag')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("EuropaBlogBundle:Tag:edit.html.twig")
     */
